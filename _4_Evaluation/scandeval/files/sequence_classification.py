...
class SequenceClassification(BenchmarkDataset):
    ...
    def _compute_metrics(
        ...
        # print("Model outputs shape:", np.asarray(model_outputs).shape)
        # print("First few model outputs:", model_outputs[:2])
        # print("First few labels:", labels[:2])
        # print("Output dtype:", np.asarray(model_outputs).dtype)  # Add this
        # print("Labels :", label2id)  # Add this
...
def get_closest_logprobs_labels(
    ...
    # print('candidate labels:', candidate_labels)  # Add this
    print('tokenizer class name:', tokenizer.__class__.__name__) 
     
    if tokenizer.__class__.__name__ in ['MorfessorTokenizer', 'MorfessorBPETokenizer']:
        add_prefix_space_to_labels = False
    else:
    ...
    print('add prefix space to labels:', add_prefix_space_to_labels)  # Add this
    ...
    # print('pred logprobs:', pred_logprobs)  # Add this
    ...
    for idx, candidate_label in enumerate(candidate_labels):
        ...
        # print('label ready for tokenization init:', label_ready_for_tokenization)  # Add this
        if add_prefix_space_to_labels:
            label_ready_for_tokenization = " " + label_ready_for_tokenization
        # print('label ready for tokenization:', label_ready_for_tokenization)  # Add this
        candidate_label_ids: list[list[int]] = tokenizer(
            [label_ready_for_tokenization], add_special_tokens=False
        )["input_ids"]
        # print('candidate label ids:', candidate_label_ids)  # Add this
        candidate_label_id: int = candidate_label_ids[0][0]
        # print('candidate label id:', candidate_label_id)  # Add this
    ...
    # print('predicted labels closets logprob:', predicted_labels)  # Add this
...
def get_closest_word_edit_labels(
    ...
    # print('raw predictions:', raw_predictions)  # Add this
    ...
    # print('candidate labels:', candidate_labels)  # Add this
    # print('new_predicted_labels:', new_predicted_labels)  # Add this
