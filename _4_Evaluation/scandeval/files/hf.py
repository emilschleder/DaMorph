...
# Morfessor models
from ..Morfessor_BPE_tokenizer import MorfessorBPETokenizer
from ..Morfessor_Raw_Tokenizer import MorfessorTokenizer
...
class HFModelSetup:
    ...
    def _load_tokenizer(
        ...
        while True:
            ...
            try:
                if 'DA-MIXED' in model_id:
                    print('using MorfessorBPETokenizer')
                    return MorfessorBPETokenizer.from_pretrained(
                        model_id, 
                        morfessor_model=True, 
                        **loading_kwargs
                    )
                elif 'DA-MORPH' in model_id:
                    print('using MorfessorTokenizer')
                    return MorfessorTokenizer.from_pretrained(
                        model_id, 
                        morfessor_model=True, 
                        **loading_kwargs
                    )
